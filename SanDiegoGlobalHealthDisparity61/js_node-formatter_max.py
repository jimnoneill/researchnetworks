...
for dictionary in data['edges']:
    if dictionary['source'] in list(id_label.values()) and dictionary['target'] in list(id_label.values()):
        ...
        dictionary.update(color_change)
    elif dictionary['source'] in list(id_label.values()) or dictionary['target'] in list(id_label.values()):
        color_ = dictionary['color'].split(',')
